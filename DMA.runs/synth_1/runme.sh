...
HD_PWD='C:/Projects/ERN24004/Projects/DMA/DMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_wrapper.tcl
