...
HD_PWD='C:/Projects/ERN24004/Projects/DMA/DMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_wrapper.tcl -notrace
