...
HD_PWD='C:/Projects/ERN24004/Projects/DMA/DMA.runs/dma_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_data_fifo_0_0.tcl
