...
HD_PWD='C:/Projects/ERN24004/Projects/DMA/DMA.runs/dma_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axi_dma_0_1.tcl
